# A Telegram HR Recruitment Bot with Google Drive Upload + Debug Secret Check
...
# 🔍 DEBUG: Check if the Google Drive secret is loaded
print("🔍 GDRIVE_SERVICE_ACCOUNT_JSON found?", bool(os.getenv("GDRIVE_SERVICE_ACCOUNT_JSON")))
...
@app.route("/")
def home():
    return "✅ Telegram HR Bot with Google Drive Debug Logging is running."
