# A Telegram HR Recruitment Bot that Uploads Resumes to Google Drive and Sends Interview Details
...
@app.route("/")
def home():
    return "✅ Telegram HR Bot with Google Drive Upload is running."
