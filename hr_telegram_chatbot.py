# A Telegram HR Recruitment Bot with Excel Integration and OpenRouter AI FAQ
...
def ask_openrouter(question):
    try:
        ...
        return "I'm sorry, I'm temporarily unable to answer that. Please try again later."
...
@app.route("/")
def home():
    return "✅ Telegram HR Bot with OpenRouter AI FAQ and Excel is running."
