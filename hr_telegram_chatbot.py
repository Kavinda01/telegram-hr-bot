# A Telegram HR Recruitment Bot with Excel Integration and AI Temporarily Disabled
...
def handle_text(chat_id, user_id, user_name, message):
    ...
    if "job opening" in message_lower or "vacancy" in message_lower:
        ...
        return "🤖 AI-powered answers are temporarily disabled. Please ask about job openings or upload your resume."
...
@app.route("/")
def home():
    return "✅ Telegram HR Bot with Excel is running. AI temporarily disabled."
